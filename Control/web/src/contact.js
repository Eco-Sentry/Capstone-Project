    ...
    return (
        <div className='Contact'>
            <div class='container-contact'>
                ...
                <div class="contact-enquiry-title">Contact Us:</div>
                    <table class="contact-enquiry-text-box-table">
                        <tr>
                            <td>
                                <table class="contact-details-table">
                                    <tr>
                                        <td><div class="h3-contact">Title:</div></td>
                                        <td><input class="details-info-boxes" type="text"></input></td>
                                    </tr>
                                    <tr>
                                        <td><div class="h3-contact">Your Name:</div> </td>
                                        <td><input class="details-info-boxes" type="text"></input></td>
                                    </tr>
                                    <tr>
                                        <td><div class="h3-contact">Email:</div></td>
                                        <td><input class="details-info-boxes" type="text"></input></td>
                                    </tr>
                                </table>
                            </td>
